        ...
        container.innerHTML = properties.map(prop => `
            <div class="property-card reveal overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <p class="text-3xl font-bold mb-4 text-black">${typeof prop.price === 'number' ? '$' + prop.price.toLocaleString() : (typeof prop.price === 'string' && prop.price.startsWith('$') ? prop.price : '$' + (prop.price || '0'))}</p>
